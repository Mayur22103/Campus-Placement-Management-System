        ...
        <div class="wrapper wrapper--w680">
            <div class="card card-4">
                <div class="card-body">
                    ...
                    <form method="POST" action="po_changepass_db.php" onsubmit="return matchPassword()">

                       
                        <div class="input-group">
                            <label class="label">New Password</label>
                            <input type="password" name="txtNewPass" id="txtNewPass" class="input--style-4">
                        </div>
                        <div class="input-group">
                            <label class="label">Re-enter Password</label>
                            <input type="password" name="txtRePass" id="txtRePass" class="input--style-4">
                        </div>
                        <div class="p-t-15">
                            <button class="btn btn--radius-2 btn--blue" type="submit" 
                                name="csubmit">Submit</button>
